	...
	<div class="container">
		...
		<form method="post" action="./categoryprocess.php">
			<div class="form-group">
				<input class="form-control" type="text" placeholder="Category Name" name="name" value="<?php echo $product['cat_name'] ?>">
			</div>		

            <div class="form-group" style="display: none;">
				<input class="form-control" type="number" placeholder="id" name="id" value="<?php echo $product['cat_id'] ?>">
			</div>
