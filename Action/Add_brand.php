...
<nav class='navbar navbar-expand-lg navbar-light bg-light '>
    ...
    <form method="post" action="./brandprocess.php" class="form" >
            
            <label for="add" style="margin-right: 15px;">Add Product</label>
            <input type="text" name="name" id="brand_name"  class="form-control" placeholder="Nike" style="width:40%;">
            <div id='contact_error' class="val_error"></div>

            <button name="addButton" type="submit" class="btn btn-primary">Primary</button>
    </form>
