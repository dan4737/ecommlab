...
$product = list_selected_products_controller($_GET['search']);
...
<nav class='navbar navbar-expand-lg navbar-light bg-light '>
 ...
 <h2 class="products__section-title">Search Results</h2>
 <div class='products'>
    <?php
        ...
        if($product == false){
          echo "
          <h2 class='products__section-title'>Sorry, No Products Available Matching Your Search</h2>
